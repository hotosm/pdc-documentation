...
![alt_text](images/0401_Aplikasi_OSMTracker_dapat_Anda_download_di_Google_Playstore.png "image_tooltip")
_Aplikasi OSMTracker dapat Anda download di Google Playstore_

Jika sudah selesai terpasang, silakan Anda buka aplikasi _OSMTracker_ pada _smartphone_ Anda.

![alt_text](images/0402_Tampilan_awal_aplikasi_OSMTracker.png "image_tooltip")
_Tampilan awal aplikasi OSMTracker_


### 2. Pengaturan Awal _OSMTracker_
Sebelum Anda dapat menggunakan _OSMTracker_, ada beberapa pengaturan dasar yang harus Anda lakukan. Untuk dapat masuk ke dalam menu pengaturan silakan Anda pilih menu tombol ![alt_text](images/0403_Tombol_settings.png "image_tooltip") di sebelah kanan atas kemudian pilih **_Settings_**. 

![alt_text](images/0404_Memilih_menu_Settings_di_aplikasi_OSMTracker.png "image_tooltip")
_Memilih menu Settings di aplikasi OSMTracker_

Pada halaman _settings_ ada beberapa pengaturan yang perlu diperhatikan, seperti:

![alt_text](images/0405_Beberapa_pengaturan_pada_halaman_Settings.png "image_tooltip")
_Beberapa pengaturan pada halaman Settings_
...
1. **Merekam Rute Perjalanan**
    ...
    ![alt_text](images/0406_Tombol_dengan_icon_+_yang_digunakan_untuk_melakukan_perekaman_jalur_atau_merekam_perjalanan_Anda.png "image_tooltip")
    _Tombol dengan icon + yang digunakan untuk melakukan perekaman jalur atau merekam perjalanan Anda_
    ...
    ![alt_text](images/0407_Fitur_trck_logger_belum_bisa_diakses_dan_bisa_diakses.png "image_tooltip")
    _Fitur track logger belum bisa diakses karena smartphone belum menangkap GPS dengan baik (Kiri); Fitur track logger dapat diakses setelah smartphone menangkap GPS (Kanan)_
...
2. **Merekam Objek dengan Titik dan Gambar**
    ...
    ![alt_text](images/0408_Halaman_track_logger_pada_OSMTracker.png "image_tooltip")
    _Halaman Track Logger pada OSMTracker_
    ...
    1. _Text Note_
        **_Text note_** digunakan untuk mengambil titik atau _waypoint_ pada saat melakukan survei. Jika Anda sudah berada di titik yang ingin Anda rekam, Anda cukup menekan tombol ini kemudian isi dengan keterangan yang Anda inginkan. Sebagai contoh, Anda dapat menggunakan penomoran diikuti dengan keterangan objeknya. 
        ...
        ![alt_text](images/0409_Contoh_penggunaan_Text_Note_untuk_merekam_titik_survei.png "image_tooltip")
        _Contoh penggunaan Text Note untuk merekam titik survei_
    ...
    2. _Take Photo_
        **_Take Photo_** digunakan untuk mengambil gambar objek yang Anda survei. Anda dapat mengambil gambar secara langsung menggunakan kamera ataupun dapat mengambilnya dari galeri foto Anda. 
        ...
        ![alt_text](images/0410_Anda_dapat_memilih_foto_lansung_atau_galeri.png "image_tooltip")
        _Anda dapat memilih untuk mengambil foto langsung menggunakan kamera atau memilih foto dari galeri foto Anda_
...
3. **Menghentikan Sementara dan Memulai Kembali Mode Rekam Rute Perjalanan**
    ...
    1. Pada halaman _Track logger_, silakan Anda kembali ke halaman utama, kemudian temukan satu _file track_ yang telah Anda kumpulkan. Pada _file_ tersebut silakan Anda tekan dan tahan beberapa saat hingga muncul menu tambahan. 
        ...
        ![alt_text](images/0411_Pilihan_untuk_menghentikan_perekaman_jalur.png "image_tooltip")
        _Pilihan untuk menghentikan perekaman jalur (Stop tracking)_

    2. Pilih menu _**Stop tracking.**_
    3. Anda juga dapat menggunakan tombol ![alt_text](images/0412_Tombol_save.png "image_tooltip") yang berada di sebelah kanan atas halaman _Track logger_ Anda untuk berhenti melakukan perekaman dan menyimpan hasil perekaman Anda. 
    ...
    1. Pada _file_ yang ingin Anda lanjutkan _track_-nya silakan Anda tekan dan tahan beberapa saat hingga muncul menu tambahan
        ...
        ![alt_text](images/0413_Pilihan_untuk_melanjutkan_kembali_perekaman_jalur.png "image_tooltip")
        _Pilihan untuk melanjutkan kembali perekaman jalur (Resume tracking)_

    2. Kemudian pilih **_Resume Tracking_**

>Catatan :
![alt_text](images/0414_ikon_tanda_jam_oranye.png "image_tooltip")
...
4. **Melihat Daftar Objek yang Dikumpulkan**
    Anda dapat melihat objek-objek apa saja yang telah Anda kumpulkan pada saat survei. Pada halaman _Track logger_ pilih tombol ![alt_text](images/0403_Tombol_settings.png "image_tooltip") yang berada di sebelah kanan atas, kemudian pilih **_Waypoints_**. 

    ![alt_text](images/0415_Tombol_untuk_menampilkan_daftar_waypoints_yang_telah_dikumpulkan.png "image_tooltip")
    _Tombol untuk menampilkan daftar waypoints yang telah dikumpulkan_

    Anda akan melihat daftar titik serta foto yang telah berhasil Anda kumpulkan pada halaman _Waypoint list._

    ![alt_text](images/0416_Halaman_waypoint_list_untuk_melihat_daftar_objek_yang_telah_dikumpulkan.png "image_tooltip")
    _Halaman Waypoint list untuk melihat daftar objek yang telah dikumpulkan_

5. **Melihat Rute Perjalanan dan Objek yang Dikumpulkan pada Peta**
    Anda juga dapat melihat sejauh apa rute perjalanan yang telah Anda lewati dan titik-titik objek yang telah dikumpulkan. Pada halaman _Track logger_ pilih menu ![alt_text](images/0403_Tombol_settings.png "image_tooltip") di sebelah kanan atas, kemudian pilih **_Display Track_**. 

    ![alt_text](images/0417_Tombol_untuk_melihat_rute_perjalanan_dan_objek_yang_telah_dikumpulkan.png "image_tooltip")
    _Tombol untuk melihat rute perjalanan dan objek yang telah dikumpulkan_
    ...
    ![alt_text](images/0418_Pilihan_untuk_menampilkan_latar_belakang_peta.png "image_tooltip")
    _Pilihan untuk menampilkan latar belakang peta_
    ...
    ![alt_text](images/0419_Contoh_hasil_rute_perjalanan_dan_titik_survei_yang_sudah_diambil_pada_saat_survei.png "image_tooltip")
    _Contoh hasil rute perjalanan dan titik survei yang sudah diambil pada saat survei_
...
1. **Menyimpan Rute Perjalanan dan Objek sebagai Data ._gpx_**
    ...
    ![alt_text](images/0420_Menu_untuk_menyimpan_data_survei_ke_dalam_file_GPX.png "image_tooltip")
        _Menu untuk menyimpan data survei ke dalam file GPX_
...
2. **Mengunggah _(Upload)_ Rute Perjalanan ke Server _OpenStreetMap_**
    ...
    ![alt_text](images/0421_Menu_untuk_mengunggah_hasil_survei_ke_dalam_server_OSM.png "image_tooltip")
        _Menu untuk mengunggah hasil survei ke dalam server OpenStreetMap_
    ...
    ![alt_text](images/0422_Contoh_file_hasil_survei_yang_telah_siap_diungah_ke_dalam_server_OpenStreetMap.png "image_tooltip")
    _Contoh file hasil survei yang telah siap diunggah ke dalam server OpenStreetMap_
...
3. **Mengambil Rute Perjalanan dan Titik ke Laptop/Komputer**
   ...
   1. Hubungkan _smartphone_ Anda ke laptop dengan menggunakan kabel data kemudian cari folder bernama _“osmtracker”_ di media penyimpanan _smartphone_ Anda. 
      ...
      ![alt_text](images/0423_Folder_OSMTracker_di_media_penyimpanan_smartphone_Anda.png "image_tooltip")
        _Folder OSMTracker di media penyimpanan smartphone Anda_
   ...
   2. Dalam folder _OSMTracker_ Anda akan menemukan satu folder yang berisi data dengan format _.gpx_ dan data foto. Silakan Anda kemudian pindahkan satu folder yang berisi data tersebut ke dalam laptop Anda.
      ...
      ![alt_text](images/0424_Contoh_data_OSMTracker_yang_berisikan_file_data_gpx_dan_foto_survei.png "image_tooltip")
        _Contoh data OSMTracker yang berisikan file data .gpx dan foto-foto survei_
   ...
   3. Buka aplikasi JOSM Anda, kemudian masukkan _file_ GPX tersebut ke dalam JOSM. Anda dapat membukanya dengan cara **File → Open**, kemudian buka _file_ dengan format _.gpx_. 
      ...
      ![alt_text](images/0425_Silakan_Anda_buka_file_dengan_format_GPX_pada_JOSM.png "image_tooltip")
        _Silakan Anda buka file dengan format .GPX pada JOSM_
     ...
     4. Pada saat Anda membuka _file_ _.gpx_ tersebut maka secara otomatis JOSM akan menampilkan rute perjalanan dan titik hasil survei lengkap dengan objek foto yang telah berhasil dikumpulkan.
        ...
        ![alt_text](images/0426_Contoh_hasil_data_survei_pada_saat_dibuka_menggunakan_JOSM.png "image_tooltip")
        _Contoh hasil data survei pada saat dibuka menggunakan JOSM_

...
![Kotak pencarian area download di JOSM](../images/0401_josm_data_quality_1.JPG "Kotak pencarian area download di JOSM")
_Kotak pencarian area download di JOSM_

*   Setelah semua selesai diatur, kemudian klik **_Download._**

![Hasil  download data di JOSM](../images/0402_josm_data_quality_2.JPG "Hasil  download data di JOSM")
_Hasil  download data di JOSM_
...
![Menu pencarian data di JOSM](../images/0403_josm_data_quality_3.JPG "Menu pencarian data di JOSM")
_Menu pencarian data di JOSM_

*   Kemudian di kotak pencarian silahkan ketik “**admin_level=7**” kemudian klik **_Start Search_**

![Jendela pencarian untuk memilih kelurahan di JOSM](../images/0404_josm_data_quality_4.JPG "Jendela pencarian untuk memilih kelurahan di JOSM")
_Jendela pencarian untuk memilih kelurahan di JOSM_
...
![Hasil pencarian kelurahan di JOSM](../images/0405_josm_data_quality_5.JPG "Hasil pencarian kelurahan di JOSM")
_Hasil pencarian kelurahan di JOSM_
...
![Hasil seleksi data di JOSM](../images/0406_josm_data_quality_6.JPG "Hasil seleksi data di JOSM")
_Hasil seleksi data di JOSM_
...
![Seleksi keseluruhan data di area tertentu di JOSM](../images/0407_josm_data_quality_7.JPG "Seleksi keseluruhan data di area tertentu di JOSM")
_Seleksi keseluruhan data di area tertentu di JOSM_

*   Setelah selesai Anda dapat melihat total jumlah objek di jendela **_properties/membership_** pada JOSM Anda.

![Seleksi keseluruhan data di area tertentu di JOSM](../images/0408_josm_data_quality_8.JPG "Seleksi keseluruhan data di area tertentu di JOSM")
_Seleksi keseluruhan data di area tertentu di JOSM_
...
![Jendela validasi data di JOSM](../images/0409_josm_data_quality_9.JPG "Jendela validasi data di JOSM")
_Jendela validasi data di JOSM_
...
![Hasil validasi data di JOSM](../images/0410_josm_data_quality_10.JPG "Hasil validasi data di JOSM")
_Hasil validasi data di JOSM_
...
![Tabel Rekapitulasi Perhitungan Data](../images/0411_josm_data_quality_11.JPG "Tabel Rekapitulasi Perhitungan Data")
...
![Langkah untuk melakukan filter data OpenStreetMap di JOSM](../images/0412_josm_data_quality_12.JPG "Langkah untuk melakukan filter data OpenStreetMap di JOSM")
_Langkah untuk melakukan filter data OpenStreetMap di JOSM_
...
![Tampilan hasil filter data untuk batas-batas administrasi di JOSM](../images/0413_josm_data_quality_13.JPG "Tampilan hasil filter data untuk batas-batas administrasi di JOSM")
_Tampilan hasil filter data untuk batas-batas administrasi di JOSM_
...
![Query untuk pencarian batas-batas RW di JOSM](../images/0414_josm_data_quality_14.JPG "Query untuk pencarian batas-batas RW di JOSM")
_Query untuk pencarian batas-batas RW di JOSM_
...
![Hasil seleksi untuk batas-batas RW di Kelurahan Pleburan](../images/0415_josm_data_quality_15.JPG "Hasil seleksi untuk batas-batas RW di Kelurahan Pleburan")
_Hasil seleksi untuk batas-batas RW di Kelurahan Pleburan_
...
_Contoh tabel rekapitulasi jumlah RW di kelurahan pemetaan_
...
![Memilih daftar RW yang ada di Kelurahan Pleburan](../images/0417_josm_data_quality_17.JPG "Memilih daftar RW yang ada di Kelurahan Pleburan")
_Memilih daftar RW yang ada di Kelurahan Pleburan_
...
![Langkah melihat informasi batas-batas RW](../images/0418_josm_data_quality_18.JPG "Langkah melihat informasi batas-batas RW")
_Langkah melihat informasi batas-batas RW_
...
_Kotak relasi dan informasi batas administrasi di JOSM_
...
![Menyalin data batas administrasi di JOSM](../images/0420_josm_data_quality_20.JPG "Menyalin data batas administrasi di JOSM")
_Menyalin data batas administrasi di JOSM_

*  Kemudian pilih **_File → New Layer_**. Anda akan melihat _layer_ baru pada _JOSM_.

![Membuat layer baru pada JOSM](../images/0421_josm_data_quality_21.JPG "Membuat layer baru pada JOSM")
_Membuat layer baru pada JOSM_

*   Kemudian klik **_Edit → Paste at source position_**


![Menyalin batas administrasi pada Layer baru pada JOSM](../images/0422_josm_data_quality_22.JPG "Menyalin batas administrasi pada Layer baru pada JOSM")
_Menyalin batas administrasi pada Layer baru pada JOSM_
...
![Menyimpan layer batas administrasi di JOSM](../images/0423_josm_data_quality_23.JPG "Menyimpan layer batas administrasi di JOSM")
_Menyimpan layer batas administrasi di JOSM_

...
![Installing plugin utilsplugin2](/en/images/0201_Installing_plugin_utilsplugin2.png)
...
![More tools menu on JOSM](/en/images/0202_More_tools_menu_on_JOSM.png)
...
![File directory for .osm file from ODK Collect](/en/images/0203_File_directory_for_osm_file_from_ODK_Collect.png)
...
![Search results for keyword “osm”](/en/images/0204_Search_results_for_keyword_osm.png)
<p align="center"><i>Search results for keyword “osm”</i><p align="center">


*   Drag all selected .osm file to **JOSM**.

![Layers Windows after .osm file from ODK and OMK dragged into JOSM](/en/images/0205_Layers_Windows_after_osm_file_from_ODK_and_OMK_dragged_into_JOSM.png)
...
![Merging all survey data layer](/en/images/0206_Merging_all_survey_data_layer.png)
...
![Saving the merged survey data layer](/en/images/0207_Saving_the_merged_survey_data_layer.png)
...
![Adding objects into Todo list](/en/images/0208_Adding_objects_into_Todo_list.png)
...
![Download Windows on JOSM](/en/images/0209_Download_Windows_on_JOSM.png)
...
![Tab “Areas around places” at Download Windows](/en/images/0210_Tab_Areas_around_places_at_Download_Windows.png)
...
![Downloading OSM data on JOSM](/en/images/0211_Downloading_OSM_data_on_JOSM.png)
...
![Merging downloaded OSM data with survey data layer](/en/images/0212_Merging_downloaded_OSM_data_with_survey_data_layer.png)
...
![Adding satellite imagery on JOSM](/en/images/0213_Adding_satellite_imagery_on_JOSM.png)
...
![Changing the display of satellite imagery](/en/images/0214_Changing_the_display_of_satellite_imagery.png)
...
![Inactivating Auto zoom for satellite imagery](/en/images/0215_Inactivating_Auto_zoom_for_satellite_imagery.png)
...
![Satellite imagery layer and merged survey data with downloaded data layer](/en/images/0216_Satellite_imagery_layer_and_merged_survey_data_with_downloaded_data_layer.png)
...
![Filter Windows on JOSM](/en/images/0217_Filter_Windows_on_JOSM.png)
<p align="center"><i>Filter Windows on JOSM</i><p align="center">

![Adding filter string in the Filter Windows](/en/images/0218_Adding_filter_string_in_the_Filter_Windows.png)
<p align="center"><i>Adding filter string in the Filter Windows</i><p align="center">

![Newly added filter in the Filter Windows](/en/images/0219_Newly_added_filter_in_the_Filter_Windows.png)
...
![Using Zoom dan Mark feature on the Todo list Windows](/en/images/0220_Using_Zoom_dan_Mark_feature_on_the_Todo_list_Windows.png)
<p align="center"><i>Using Zoom dan Mark feature on the Todo list Windows</i><p align="center"> 
    
![Tags suitable for point object](/en/images/0221_Tags_suitable_for_point_object.png)
<p align="center"><i>Tags suitable for point object</i><p align="center">

![Copying building related tags using Shift + R](/en/images/0222_Copying_building_related_tags_using_Shift_R.png)
...
![School point from survey data](/en/images/0223_School_point_from_survey_data.png)
<p align="center"><i>School point from survey data</i><p align="center">

![Tags suitable for school building](/en/images/0224_Tags_suitable_for_school_building.png)
<p align="center"><i>Tags suitable for school building</i><p align="center">
    
![Tags suitable for school area](/en/images/0225_Tags_suitable_for_school_area.png)
...
![Upload Windows on JOSM](/en/images/0226_Upload_Windows_on_JOSM.png)
...
![Save OSM File Windows on JOSM](/en/images/0227_Save_OSM_File_Windows_on_JOSM.png)
...
![OSM map before and after mapping process](/en/images/0228_OSM_map_before_and_after_mapping_process.png)

...
_Data example from Wedomartani Village, Sleman, Yogyakarta_
...
_ODK Collect Data copied in laptop/computer_
...
_Drag and open the .osm file on JOSM_
...
_Combine all different layers into one single layer_
...
_Choose merge to combine all the data_
...
_Comparison between raw data and existing data attribute  on OSM_
...
_Node placement difference between raw data and existing OSM data_
...
2. Using Validation Tool
 ...
 _Downloaded OpenStreetMap data_
...
_Activating validation window on JOSM_
...
_Validation result using JOSM_
...
**IV. Definition of Error and Warning on JOSM**
...
_Error and warning when doing a validation_
...
_You can automatically repair errors using Fix button_

**V. List of Error and Warning needed to be Repair**

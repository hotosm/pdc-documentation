...
![Menu pilihan untuk memasukkan alamat URL pada ODK Collect](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0201_0202_general_settings.png "server")
...
![Langkah untuk memasukkan alamat URL pada ODK Collect](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0203_0204_URL.png "Langkah untuk memasukkan alamat URL pada ODK Collect")
...
![Menu pilihan untuk mengatur resolusi gambar](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0205_0206_form_management.png "Menu pilihan untuk mengatur resolusi gambar")
...
![Menu pilihan Image Size untuk menentukan besar resolusi gambar](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0207_0208_image_size.png "Menu pilihan Image Size untuk menentukan besar resolusi gambar")
...
![Pilihan Get Blank Form untuk mengambil formulir pada server](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0209_get_blank_form.png "Pilihan Get Blank Form untuk mengambil formulir pada server")
...
![Tampilan halaman pada menu Get Blank Form](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0210_getblank_select.png "Tampilan halaman pada menu Get Blank Form")
...
![Tampilan halaman pada pilihan Get Blank Form untuk mengambil formulir survei](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0211_getblank_get.png "Tampilan halaman pada pilihan Get Blank Form untuk mengambil formulir survei")
...
![Pilihan Fill Blank Form untuk mengisi formulir survei dan daftar formulir survei kosong](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0212_0213_fill_blank_form.png "Pilihan Fill Blank Form untuk mengisi formulir survei dan daftar formulir survei kosong")
...
![Contoh pertanyaan yang wajib diisi tanda bintang merah](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0214_fill_blank_form.png "Contoh pertanyaan yang wajib diisi tanda bintang merah")
...
![Tampilan halaman pertanyaan pada formulir untuk mengambil foto](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0215_take_picture.png "Tampilan halaman pertanyaan pada formulir untuk mengambil foto")
...
![Tombol Launch OpenMapKit pada formulir survei](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0216_launch_omk.png "Tombol Launch OpenMapKit pada formulir survei")
...
![Tampilan halaman finalisasi akhir pada formulir survei](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0217_save_form.png "Tampilan halaman finalisasi akhir pada formulir survei")
...
![Pilihan Edit Saved Form untuk mengubah formulir survei](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0218_edit_saved_form.png "Pilihan Edit Saved Form untuk mengubah formulir survei")
...
![Tampilan halaman Edit Saved Form untuk memilih formulir yang akan diubah](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0219_edit_saved_form.png "Tampilan halaman Edit Saved Form untuk memilih formulir yang akan diubah")
<p align="center"><i>Tampilan halaman Edit Saved Form untuk memilih formulir yang akan diubah</i></p>

*   Setelah itu, simpan formulir dengan cara tekan ikon disket <img src="/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0220_disk_icon.png"> untuk simpan perubahan pada formulir survei.

![Tampilan formulir survei yang sudah diisi dan ikon untuk simpan perubahan formulir](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0221_0222_edit_saved_form.png "Tampilan formulir survei yang sudah diisi dan ikon untuk simpan perubahan formulir")
...
![Pilihan Send Finalized Form untuk mengupload formulir survei ke server](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0223_send_finalized.png "Pilihan Send Finalized Form untuk mengupload formulir survei ke server")
...
![Tampilan formulir survei yang siap dikirim pada pilihan Send Finalized Form](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0224_send_selected.png "Tampilan formulir survei yang siap dikirim pada pilihan Send Finalized Form")
...
![Pilihan View Sent Form dan formulir survei yang telah berhasil di-upload ke server](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0225_0226_view_sent_form.png "Pilihan View Sent Form dan formulir survei yang telah berhasil di-upload ke server")
...
![Pilihan Delete Saved Form untuk menghapus formulir](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0227_delete_saved_form.png "Pilihan Delete Saved Form untuk menghapus formulir")
...
![Tampilan pilihan Delete Saved Form](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0228_0229_delete_selected.png "Tampilan pilihan Delete Saved Form")
...
![Kotak dialog untuk konfirmasi hapus formulir](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0230_delete_selected.png "Kotak dialog untuk konfirmasi hapus formulir")
...
![Folder instances di dalam folder odk dan isi folder instances hasil survei](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0231_0232_instances.png "Folder instances di dalam folder odk dan isi folder instances hasil survei")
...
![Langkah untuk kompresi file menjadi format zip](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0233_0234_compress.png "Langkah untuk kompresi file menjadi format zip")
...
![File zip yang siap untuk dipindahkan ke komputer](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0235_zip.png "File zip yang siap untuk dipindahkan ke komputer")
...
![Tampilan folder pada Google Drive untuk upload file zip](/id/images/01-OSM-Field-Surveyor-Guideliness/02-Menggunakan-Aplikasi-ODK-Collect/0236_gdrive.png "Tampilan folder pada Google Drive untuk upload file zip")

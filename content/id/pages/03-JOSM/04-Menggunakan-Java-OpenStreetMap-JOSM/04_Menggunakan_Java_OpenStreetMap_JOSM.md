...
![open_a_file](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0401_Ikon_Open_a_file.png)
...
![file_latihan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0402_Tampilan_file_latihan_di_JOSM.png)
...
![skala_baris](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0403_Skala_baris_di_JOSM.png)
...
![ikon](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0404_Ikon_tool_select_move_scale_and_rotate_object.png)
...
![informasi_objek](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0405_Informasi_objek_di_panel_Tags_JOSM.png)
...
![contoh_mengubah_objek](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0406_Contoh_mengubah_objek.png)
...
![draw_tool](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0407_Ikon_Draw_Tool.png)
...
![menggambar_titik](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0408_Contoh_menggambar_objek_titik.png)
...
![menggambar_garis](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0409_Contoh_menggambar_objek_garis.png)
...
![menggambar_poligon](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0410_Contoh_menggambar_objek_poligon.png)
...
![memasukkan_presets](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0411_Memasukkan_preset.png)
...
![jendela_search](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0412_Jendela_search_preset.png)
...
![jendela_informasi](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0413_Jendela_informasi_objek.png)
...
![tampilan_file](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0414_Tampilan_file_latihan_mengedit_di_JOSM.png)
...
![pilihan_menu_tool](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0415_Pilihan_yang_ada_di_menu_tools_JOSM.png)
...
![split_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0416_Tampilan_split_way.png)
...
![combine_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0417_Tampilan_combine_way.png)
<p align="center"><i>Tampilan combine way</i></p>

![menggabungkan_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0418_Hasil_menggabungkan_Garis_Way_JOSM.png)
...
![peringatan_change_direction](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0419_Peringatan_change_directions.png)
...
![reverse_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0420_Tampilan_reverse_ways.png)
...
![simplify_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0421_Tampilan_simplify_way.png)
...
![align_node_in_circle](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0422_Tampilan_Align_Nodes_in_Circle.png)
...
![create_circle](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0423_Tampilan_create_cirle.png)
...
![align_node_in_line](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0424_Tampilan_align_nodes_in_line.png)
<p align="center"><i>Tampilan align nodes in line</i></p>

![setelah_align_node_in_line](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0425_Contoh_setelah_menggunakan_align_nodes_in_line.png)
...
![orthogonalize_shape](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0426_Tampilan_orthogonalize_shape.png)
<p align="center"><i>Tampilan orthogonalize shape</i></p>

![setelah_ortho_shape](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0427_Contoh_setelah_menggunakan_orthogonalize_shape.png)
...
![unglue_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0428_Tampilan_unglue_way.png)
<p align="center"><i>Tampilan unglue way</i></p>

![setelah_unglue](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0429_Contoh_setelah_menggunakan_unglue_way.png)
...
![konsep_memutar_object](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0430_Konsep_memutar_objek_di_JOSM.png)
...
|No.| Perintah  | Simbol  |
|---|---|---|
|1|Aktifkan _Select Tool_|![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0431_Select_Tool.png)|
|2|Aktifkan _Draw Tool_|![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0432_Draw_Tool.png)|
|3|Aktifkan _Zoom Tool_|![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0433_Zoom_Tool.png)|
|4|Hapus objek yang terpilih|![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0434_Hapus.png)|
|5|_Zoom In_|![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0435_Zoom_In.png)|
|6|_Zoom Out_|![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0436_Zoom_Out.png)|
...
![bangunan_jalan_terpisah](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0437_Objek_bangunan_dan_jalan_yang_tersambung_dan_objek_bangunan_dan_jalan_yang_terpisah.png)
...
![jalan_harus_terhubung](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0438_Jalan_harus_terhubung_satu_sama_lain.png)
...
![poligon_overlap](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0439_Contoh_poligon_yang_saling_overlap.png)
...
![poligon_sekolah](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0440_Contoh_sekolah_dengan_poligon_keseluruhan_halaman_sekolah_dan_bangunannya.png)
...
| Kesalahan  |Tips   |
|---|---|
|Tag diberikan pada node, bukan pada objek (misalnya: bangunan) ![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0441_Contoh_bangunan_yang_diberikan_tag_yang_salah_dan_benar.png) |Satu masalah umum yang sering terjadi yaitu menambahkan tag pada node atau titik yang terdapat pada bagian dari sebuah garis atau poligon. Ini sering terjadi ketika seseorang menggambar sebuah objek, kemudian melakukan _select all)_ pada objek (memilih semua titik/_select node_ pada garis). Kemudian seseorang menambahkan _presets_, sehingga tag terdapat di setiap sudut poligon, ini adalah cara yang tidak tepat. Cara untuk menghindari hal ini, dengan klik objek secara langsung pada garis atau hindari _select all_ pada objek.|
|Persimpangan yang bertemu di sudut jalan atau persimpangan jalan harus dipisah ![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0442_Contoh_pembuatan_simpangan_yang_salah_dan_benar.png) |Ketika jalan bersinggungan atau persimpangan satu sama lain di sudut jalan, Anda tidak boleh membuat garis melengkung di persimpangan. Garis seharusnya berbentuk sudut 90° dan terpisah menjadi dua segmen garis yang berbeda, seperti di kondisi yang sebenarnya di lapangan|
|Tidak ada tag pada node atau garis ![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0443_Contoh_tidak_ada_tag_pada_node_atau_garis.png)|Untuk memperbaiki kesalahan ini, pilih objek dan masukan _presets_ sesuai dengan informasi objek tersebut atau bisa dihapus bila objek itu merupakan kesalahan. Hal ini dikarenakan, server OSM tidak bisa membaca sebuah objek yang tidak dilengkapi dengan presets (informasi objek).|
|Garis berada dekat dengan garis lain tetapi tidak terhubung ![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0444_Contoh_garis_jalan_yang_tidak_saling_terhubung.png)|Untuk memperbaikinya, Anda dapat memilih titik dari garis yang ingin dihubungkan dan kemudian pilih _tool Draw nodes_ untuk menambahkan titik di garis yang mendatar/garis yang berada di depannya. Alternatif lainnya, Anda dapat menggunakan _tool Merge Node_ (jika di depan garis yang belum terhubung tersebut merupakan sebuah titik), caranya: 1. Pilih kedua titik yang berdekatan, yang berada di dalam kedua garis yang ingin dihubungkan. 2. Pilih _Merge Node_ yang berada di  _Menu tools_. Jika didepan garis yang belum terhubung tersebut tidak terdapat sebuah titik, Anda bisa menggunakan _tool Join Node to Way_ dengan cara: 1. Pilih titik terakhir dari garis yang belum terhubung dan juga pilih garis yang berada di depan garis yang belum terhubung. 2. Pilih _Join Node to Way_ yang Berada Di _Menu Tools_|
|Garis tidak boleh melewati bangunan ![](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0445_Contoh_salah_garis_melewati_bangunan.png) |Untuk mengatasinya, Anda perlu melihat menggunakan citra satelit objek mana yang berada pada lokasi yang salah. Kemudian Anda dapat menggeser objek tersebut ke tempat yang sesuai. Contoh garis yang tidak boleh melewati bangunan misalnya sungai.|
...
![contoh_jembatan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0446_Contoh_objek_jembatan.png)
...
![gambar_jaringan_sungai](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0447_Contoh_gambar_jaringan_sungai.png)
<p align="center"><i>Contoh gambar jaringan sungai</i></p>

*   Gambar jaringan jalan yang melintasi (di atas) sungai tersebut.

![gambar_jaringan_jalan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0448_Contoh_gambar_jaringan_jalan_di_atas_sungai.png)
...
![gambar_ujung_jembatan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0449_Contoh_gambar_ujung_jembatan.png)
...
![gambar_titik_setiap_ujung](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0450_Gambar_titik_di_setiap_ujung_jembatan.png)
...
![split_way](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0451_Contoh_split_way.png)
...
![jalan_sudah_terbagi](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0452_Jalan_sudah_terbagi_menjadi_tiga_segmen.png)
...
![meambahkan_jembatan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0453_Cara_menambahkan_jembatan.png)
...
![informasi_untuk_jembatan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0453_Cara_menambahkan_jembatan.png)
<p align="center"><i>Informasi yang harus diisi untuk jembatan</i></p>

*   Selesai.

![gambar_jembatan_berhasil_dibuat](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0455_Contoh_gambar_jembatan_yang_sudah_berhasil_dibuat.png)
<p align="center"><i>Contoh gambar jembatan yang sudah berhasil dibuat</i></p>

![contoh_gambar_jembatan_dan_infonya](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0456_Contoh_gambar_jembatan_dan_informasinya_di_bagian_panel_tags.png)
...
![contoh_beberapa_bangunan_sekolah](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0457_Contoh_beberapa_bangunan_sekolah.png)
...
![gambar_a_b](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0458_Gambar_a_dan_gambar_b.png)
...
![gambar_object_di_sekolah](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0459_Contoh_gambar_objek_objek_yang_terdapat_di_dalam_sekolah.png)
...
![gambar_garis_terluar](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0460_Gambar_garis_terluar_dari_sekolah.png)
...
![gambar_a_b](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0461_Gambar_a_dan_Gambar_b.png)
<p align="center"><i>Gambar a dan Gambar b</i></p>
...
![sebagian_jalan_thamrin](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0462_Sebagian_Jalan_Thamrin.png)
...
![gambar_jalan_dari_bawah_keatas](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0462_Sebagian_Jalan_Thamrin.png)
<p align="center"><i>Gambar jalan dari bawah ke atas (selatan ke utara)</i></p>

![gambar_jalan_utara_selatan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0464_Gambar_jalan_dari_atas_ke_bawah_utara_ke_selatan.png)
...
![jalan_sudirman](pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0465_Salah_satu_bagian_Jalan_Sudirman_Jakarta_Pusat.png)
<p align="center"><i>Salah satu bagian Jalan Sudirman, Jakarta Pusat, yang terdiri dari empat ruas (tiga pembatas jalan)</i></p>

![tampilan_ruas_jalan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0466_Tampilan_ruas_jalan_di_atas_pada_citra_satelit.png)
<p align="center"><i>Tampilan ruas jalan di atas, pada citra satelit</i></p>

![kondisi_ruas_jalan](/pages/03-JOSM/04-Menggunakan-Java-OpenStreetMap-JOSM/images/0467_Ruas_jalan_tersebut_meskipun_merupakan_1_jalan_yang_sama_yaitu_jalan_sudirman.png)

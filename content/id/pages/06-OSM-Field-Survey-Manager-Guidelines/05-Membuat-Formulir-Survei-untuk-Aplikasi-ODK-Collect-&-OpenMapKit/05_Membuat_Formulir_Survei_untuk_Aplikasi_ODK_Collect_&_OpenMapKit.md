...
![Contoh format XLSForm](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0501_contoh_format_XLSForm.png)
...
![Contoh format XForm](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0502_contoh_format_XForm.png)
...
#### a. Tiga lembar kerja/_sheet_ utama.
...
![Tiga Lembar Kerja Utama di setiap XLSForm](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0503_tiga_lembar_kerja_utama.png)
...
##### b.1. Kolom pada Lembar Kerja *survey*
...
![Contoh kolom untuk lembar kerja survey](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0504_ct_kolom_survey.png)
<p align="center"><i>Contoh kolom untuk lembar kerja survey</i></p>

##### b.2. Kolom pada Lembar Kerja *choices*
...
![Contoh penamaan kolom pada lembar kerja choices](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0505_penamaan_kolom_choices.png)
<p align="center"><i>Contoh penamaan kolom pada lembar kerja **choices**</i></p>

##### b.3. Kolom pada Lembar Kerja *settings*
...
![Contoh penamaan kolom pada lembar kerja settings](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0506_pengaturan_settings.png)
<p align="center"><i>Contoh penamaan kolom pada lembar kerja settings</i></p>

#### c. Semua isian harus dengan format standar dan dimulai dari kotak paling pertama.
...
![Posisi awal membuat formulir survei](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0507_posisi_awal_membuat_formulir_survei.png)
...
![Contoh tipe pertanyaan text](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0508_contoh_tipe_pertanyaan_text.png)
<p align="center"><i>Contoh tipe pertanyaan text</i></p>

### b. Tipe pertanyaan *integer/decimal*
...
![Contoh tipe pertanyaan integer](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0509_contoh_tipe_pertanyaan_integer.png)
<p align="center"><i>Contoh tipe pertanyaan integer</i></p>

### c. Tipe pertanyaan *select_one*
...
![Contoh tipe pertanyaan select_one](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0510_contoh_select_one.png)
...
### d. Tipe pertanyaan *select_multiple*
...
![Contoh tipe pertanyaan select_multiple](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0511_contoh_select_multiple.png)
...
![Contoh penggunaan tipe pertanyaan geopoint](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0512_contoh_geopoint.png)
...
![Contoh penggunaan tipe note](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0513_contoh_note.png)
...
![Contoh penggunaan tipe image](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0514_contoh_image.png)
...
![Contoh penggunaan kolom hint](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0515_contoh_kolom_hint.png)
...
![Contoh penggunaan fitur required](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0516_contoh_penggunaan_fitur_required.png)
...
![Contoh penggunaan fitur field-list pada beberapa kelompok pertanyaan](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0517_contoh_field-list.png)
...
1. Membuat tipe pertanyaan awal
    ...
    ![Contoh pertanyaan pada lembar kerja survey](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0518_contoh_lembar_kerja_survey.png)
...
2. Membuat pilihan jawaban pada lembar kerja **choices**
    ...
    ![Contoh pilihan jawaban pada lembar kerja choices](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0519_contoh_pilihan_jawaban_choices.png)
...
3. Memasukkan fitur **relevant** pada pertanyaan selanjutnya
    ...
    ![Contoh pembuatan fitur relevant](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0520_contoh_pembuatan_fitur_relevant.png)
...
Secara umum, kebutuhan lembar kerja untuk membuat _OpenMapKit_ tidak jauh berbeda dengan format _ODK Collect_. Lembar kerja yang dibutuhkan oleh _ODK Collect_ adalah **survey, choices,** & **settings**. Namun untuk _OpenMapKit_, kita harus **menambahkan lembar kerja baru bernama _osm_**. 
    
![Lembar kerja utama untuk OpenMapKit](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0521_lembar_kerja_utama_untuk_openmapkit.png)
...
![Tipe pertanyaan osm dengan variabel yang sama di lembar kerja osm](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0522_tipe_pertanyaan_osm.png)
...
![Kolom **name** mengikuti aturan key dan value pada OSM](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0523_aturan_key_dan_value_pada_osm.png)
...
Setelah itu, pada lembar kerja **survey** kita harus memberikan kolom utama kita, yaitu kolom **type, name** & **label**. Jenis tipe pertanyaan yang harus kita buat untuk formulir survei ini adalah **text, select_one** & **geopoint**. 
  ...
  ![Tipe pertanyaan untuk lembar kerja survey](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0524_tipe_pertanyaan_untuk_lembar_kerja_survey.png)
...
Pada lembar kerja **choices** kita memasukkan pilihan jawaban untuk tipe pertanyaan **select_one** yang sudah kita buat pada lembar kerja **survey**. Disini kita harus membuat tiga kolom utama yaitu **list_name, name,** & **label**.
  ...
  ![Pilihan jawaban yang dimasukkan pada lembar kerja choices](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0525_pilihan_jawaban_lembar_kerja_choices.png)
...
Karena kita ingin menggunakan _OpenMapKit_ untuk pengumpulan data lapangan kita, kita harus menambahkan tipe pertanyaan yang nantinya akan mengarahkan kita ke aplikasi _OpenMapKit_, tipe pertanyaan yang harus kita masukkan adalah **osm**. Pada lembar kerja **osm** kita memasukkan semua pertanyaan yang berkaitan dengan _OpenMapKit_. Pada variabel **name** kita harus mengacu kepada _key_ dan _value_ di wikipedia _OpenStreetMap_.
  ...
  ![Isi lembar kerja survey dan osm](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0526_isi_lembar_kerja_survey_dan_osm.png)
...
Terakhir, pada lembar kerja **settings** kita memasukkan id formulir kita dan judul formulir kita. Pada lembar kerja ini, hanya dibutuhkan dua kolom utama, yaitu **form_id** dan **title.**
  ...
  ![Contoh pengaturan pada lembar kerja settings](/id/images/06-OSM-Field-Survey-Manager-Guidelines/05-Membuat-Formulir-Survei-untuk-Aplikasi-ODK-Collect-&-OpenMapKit/0527_contoh_pengaturan_pada_lembar_kerja_settings.png)
